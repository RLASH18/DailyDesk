...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="../DailyDesk/index.php" class="logo d-flex align-items-center me-auto">
            ...
            <a href="../DailyDesk/auth/login.php" class="btn-getstarted">Login</a>
        </div>
    </header>
        ...
        <section class="hero section" id="hero">
            ...
            <div class="container">
                ...
                <div class="text-center" data-aos="zoom-out" data-aos-delay="100">
                    <a href="../DailyDesk/auth/register.php" class="btn-get-started">Get Started</a>
                </div>
