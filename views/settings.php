                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4 profile-pic-section text-center d-flex flex-column align-items-center justify-content-center">
                                        <div class="profile-pic-wrapper">
                                            <img src="../uploads/profile_pics/<?php echo htmlspecialchars($user['profile_pic'] ?? 'default.png'); ?>"
                                                alt="Profile Picture"
                                                class="profile-pic"
                                    ...
                                    <div class="col-md-8 d-flex align-items-center">
                                        <div class="card-body p-4 p-lg-5 text-black">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="email" id="email" class="form-control" value="<?php echo htmlspecialchars($user['email']); ?>" readonly>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label for="new_password0" class="form-label">Confirm New Password</label>
