...
<body>
                    ...
                    <div class="custom-card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="card-value"><?php echo htmlspecialchars($total_task); ?></h4>
                            </div>
                            <div class="card-icon">
                    ...
                    <div class="custom-card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="card-value"><?php echo htmlspecialchars($total_journal_entry); ?></h4>
                            </div>
                            <div class="card-icon">
                    ...
                    <div class="custom-card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="card-value">₱ <?php echo htmlspecialchars($total_balance); ?></h4>
                            </div>
                            <div class="card-icon">
    ...
    <div id="productivity-data"
        data-productivity='<?php echo htmlspecialchars($productivity_data, ENT_QUOTES, 'UTF-8'); ?>'
        style="display: none;">
    </div>
